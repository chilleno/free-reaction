...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden gradient-green-y-bg pb-28 pt-20 sm:py-32"
    >
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Explore the future of content creation with Reaction Free.
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Our innovative tools and resources ensure that your reactions are both engaging and copyright-safe.
          </p>
        </div>
        <Tab.Group
          as="div"
